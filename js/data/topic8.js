...
const TOPIC_8_QUESTIONS = [
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "A primeira opção confunde física nuclear de decaimento atómico com transformações físicas de detergentes domésticos.",
      "A segunda opção é absurda; a semivida física é uma constante intrínseca do núcleo, imutável pela iluminação externa.",
      "A terceira opção recorre a crendices populares sem qualquer respaldo nas leis da física ou da medicina."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "A primeira opção é perigosa e inútil; o calor não anula a radioatividade e provocaria queimaduras orofaringeas.",
      "A segunda opção violaria gravemente as leis de gestão de resíduos e colocaria em risco os assistentes operacionais e o público.",
      "A terceira opção violaria o dever deontológico de assistência ao doente; o isolamento tem regras de tempo e proteção, não de abandono."
    ],
    "nursingApplication": "O enfermeiro sabe que a tiroide humana capta o radioisótopo Iodo-131 exatamente da mesma forma química que capta o isótopo estável dietético Iodo-127."
  },
  {
    ...
    "distractorAnalysis": [
      "A primeira opção viola a fórmula harmónica da meia-vida efetiva, que é sempre menor do que Tf e Tb.",
      "A segunda opção atribui falsamente partículas alfa ao Tecnécio-99m, que é um emissor gama puro de 140 keV.",
      "A terceira opção é falsa: radioisótopos diagnósticos têm semividas curtas (horas) e decaem quase totalmente em 24 a 48 horas."
    ],
    "nursingApplication": "O enfermeiro sabe que a tiroide humana capta o radioisótopo Iodo-131 exatamente da mesma forma química que capta o isótopo estável dietético Iodo-127."
  },
  {
