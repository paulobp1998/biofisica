...
const TOPIC_4_QUESTIONS = [
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inverte a velocidade na fração, gerando uma unidade incorreta de m²/(m/s) = m·s.",
      "Está incorreta: mistura energia e forças gravitacionais sem fundamentação na definição de fluxo volumétrico.",
      "Está incorreta: calcula o impulso da força de pressão ao longo do tempo (F · t), não o caudal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignora a gigantesca variação na área transversal combinada entre a aorta e a microcirculação.",
      "Está incorreta: afirma o oposto da equação da continuidade (v = Q / A; maior área implica MENOR velocidade).",
      "Está incorreta: violaria a conservação de massa: o volume que entra nos capilares tem de ser rigorosamente igual ao volume ejetado pelo coração."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde escoamento contínuo de fluidos dinâmicos com o impacto estático de uma barreira bloqueada.",
      "Está incorreta: viola abertamente a lei de conservação de energia do Teorema de Bernoulli.",
      "Está incorreta: é absurda; o sangue continua a escoar na estenose em alta velocidade sem emissão fotónica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a definição exata de regime turbulento.",
      "Está incorreta: descreveria um perfil plano (plug flow) de fluido não-viscoso ideal sem atrito parietal.",
      "Está incorreta: violaria o sentido fisiológico anterógrado da circulação cardiovascular mantido pelo coração e válvulas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: misturam conceitos clínicos e variáveis arbitrárias sem qualquer sustentação na mecânica dos fluidos universal.",
      "Está incorreta: misturam conceitos clínicos e variáveis arbitrárias sem qualquer sustentação na mecânica dos fluidos universal.",
      "Está incorreta: misturam conceitos clínicos e variáveis arbitrárias sem qualquer sustentação na mecânica dos fluidos universal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: eleva massivamente a viscosidade η no denominador, o que diminui o número de Reynolds e estabiliza o fluxo laminar (embora aumente a sobrecarga pressórica e o risco trombótico).",
      "Está incorreta: reduz a velocidade v e eleva a viscosidade pelo frio, diminuindo francamente o Número de Reynolds.",
      "Está incorreta: provoca hemoconcentração que eleva a viscosidade, reduzindo Re."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é um erro crassíssimo; o raio é de longe o fator mais determinante de todo o sistema.",
      "Está incorreta: afirma o inverso absurdo da física de fluidos.",
      "Está incorreta: é uma afirmação sem base na equação de Poiseuille."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: considera erroneamente uma proporção linear com o raio (r¹).",
      "Está incorreta: considera erroneamente uma dependência com a área de secção transversal (r²).",
      "Está incorreta: ignora a resistência hidrodinâmica interna do tubo governada pelo calibre interno."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola as leis do atrito viscoso ao longo das paredes sólidas de um tubo.",
      "Está incorreta: ignora a variável L expressa na fórmula de Poiseuille.",
      "Está incorreta: confunde uma linha de infusão passiva com bombas aspirativas ativas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: refere-se a vasos de capacitância venosa de baixa pressão e alta complacência.",
      "Está incorreta: atua como vaso amortecedor elástico de Windkessel, mas oferece resistência mínima ao fluxo.",
      "Está incorreta: é apenas um leito capilar especializado num único órgão."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve fluidos simples ideais ou a água pura.",
      "Está incorreta: é fisiologicamente absurda; o sangue circula na escuridão do leito vascular interno.",
      "Está incorreta: ignora a biofísica hemoreológica consolidada."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: provocaria paragem imediata da circulação com morte celular de todos os tecidos.",
      "Está incorreta: é o oposto exato do que comprova a biofísica da microcirculação.",
      "Está incorreta: é uma distorção biológica; as hemácias continuam a ser a vasta maioria das células em trânsito microvascular."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: tem impacto secundário marginal comparado com o volume celular dos milhares de milhões de hemácias.",
      "Está incorreta: refere-se a células do sistema imunitário presentes em concentrações milhares de vezes inferiores às hemácias.",
      "Está incorreta: é uma variável de excreção exócrina da pele sem influência reológica direta."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve o 2.º tom cardíaco (S2) na auscultação torácica precordial, não os ruídos de Korotkoff braquiais.",
      "Está incorreta: é absurda; o ar da braçadeira permanece estanque dentro da bolsa pneumática sem contacto intravascular.",
      "Está incorreta: refere ruídos espúrios de artefacto de movimento externo que o enfermeiro treinado sabe distinguir e evitar."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é o inverso absoluto da realidade; o fluxo sanguíneo está perfeitamente normal e restaurado.",
      "Está incorreta: é um absurdo reológico evidente.",
      "Está incorreta: é uma justificação fantasiosa para falha de equipamento."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ocorreria com uma braçadeira excessivamente LARGA em braços muito magros (onde a leitura é falsamente subestimada).",
      "Está incorreta: ignora os princípios de transmissão mecânica de pressão nos tecidos corporais.",
      "Está incorreta: é uma afirmação sem base na prática médica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a descida do fluido com uma redução pressórica inexistente.",
      "Está incorreta: nega os princípios elementares da hidrostática e a ação do campo gravítico sobre a massa do sangue.",
      "Está incorreta: viola a anatomia e a fisiologia da circulação sistémica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contradiz a fórmula direta de Laplace; maior raio implica MAIOR tensão parietal.",
      "Está incorreta: confunde calcificação aterosclerótica da placa íntima com proteção esquelética consolidada.",
      "Está incorreta: violaria a mecânica dos fluidos corporais sob pressão do ventrículo esquerdo."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola a lei física que exige gradiente positivo de pressão no sentido do fluxo.",
      "Está incorreta: confunde refluxo hidrodinâmico com forças de ejeção mecânica externa.",
      "Está incorreta: é uma impossibilidade biológica e hematológica elementar."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque ; as bombas exigem ligação à rede elétrica e dispõem de baterias recarregáveis internas.",
      "Está incorreta: é um absurdo clínico que causaria embolia pulmonar massiva fatal imediata.",
      "Está incorreta: confunde uma bomba de fluidoterapia com fontes de radiação ionizante de medicina nuclear."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: propõe massas gigantescas que romperiam o frasco e matariam o doente.",
      "Está incorreta: propõe um valor irreal que produziria um spray microscópico contínuo.",
      "Está incorreta: inverte a prática clínica; transfusões de sangue utilizam sistemas macrogotas com filtro específico de 170-200 μm para não hemolisar as hemácias."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: exagera grotescamente a taxa de hemorragia venosa.",
      "Está incorreta: é fisiologicamente impossível em fenómenos de embolia mecânica.",
      "Está incorreta: confunde ar ambiente com produção de líquor pelos plexos coróideos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve o papel das artérias musculares e elásticas de alta pressão.",
      "Está incorreta: é contrária à histologia venosa que é extremamente maleável e distensível.",
      "Está incorreta: descreve a hematose pulmonar dos alvéolos e capilares pulmonares."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde parede elástica passiva com contração muscular voluntária somática do músculo esquelético.",
      "Está incorreta: impediria a perfusão diastólica dos tecidos que é contínua e vital.",
      "Está incorreta: é biologicamente absurda."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria válida apenas se a sístole e a diástole tivessem exatamente a mesma duração temporal (o que só ocorre em taquicardias extremas).",
      "Está incorreta: propõe uma multiplicação adimensional sem lógica de grandezas de pressão.",
      "Está incorreta: define a Pressão de Pulso ou Pressão Diferencial (PP = PAS - PAD)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é absurda; o coração continua a funcionar normalmente no mediastino.",
      "Está incorreta: descreveria uma fístula gastrovascular inexistente no topo do tórax.",
      "Está incorreta: inventa uma transmutação hematológica desprovida de realidade biológica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve a ação da pressão hidrostática capilar, não da pressão oncótica de atração osmótica.",
      "Está incorreta: confunde osmorregulação com a cascata de coagulação da trombina e fibrina.",
      "Está incorreta: ignora a função vital do sistema linfático, que drena os 2 a 4 litros diários de excesso fisiológico de filtração líquida."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola as leis da hidrostática; o peso da coluna de fluido aumenta a pressão nas zonas inferiores.",
      "Está incorreta: só ocorreria em ambiente de microgravidade no espaço sideral.",
      "Está incorreta: é uma formulação fantasiosa sem sentido clínico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: causaria reabsorção excessiva de água para dentro dos vasos, prevenindo o edema em vez de provocá-lo.",
      "Está incorreta: impediria a passagem de líquido transvascular.",
      "Está incorreta: é uma descrição sem sentido biomédico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve o comportamento de artérias periféricas convencionais (como a renal ou cerebral), não das coronárias intramurais esquerdas.",
      "Está incorreta: é fisiologicamente infundada.",
      "Está incorreta: ignora a espessura da parede miocárdica (que excede a capacidade de difusão simples transendotelial de ~100 μm)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: mistura instrumentos médicos com métodos de datação radiométrica arqueológica.",
      "Está incorreta: descreve o esfigmomanómetro de coluna de mercúrio clássico (descontinuado em hospitais por razões de toxicidade ambiental).",
      "Está incorreta: é uma afirmação sem base na engenharia biomédica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a hematose com ausência de perfusão celular.",
      "Está incorreta: nega o valor uniforme da aceleração da gravidade terrestre no corpo humano.",
      "Está incorreta: é um disparate; o sangue é um líquido aquoso incompressível em qualquer vaso."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: introduzem grandezas astrofísicas e criogénicas desconectadas da termodinâmica de fluidos corporais.",
      "Está incorreta: confunde pressão relativa com escalas absolutas de tensão mecânica.",
      "Está incorreta: confunde pressão relativa com escalas absolutas de tensão mecânica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde pressão (medida em mmHg) com frequência de batimentos cardíacos (bpm ou Hz).",
      "Está incorreta: propõe uma operação inventada entre variáveis laboratoriais e temporais.",
      "Está incorreta: descreve a palpação manual externa do pulso radial, não a grandeza hemodinâmica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve o comportamento de fluidos ideais sem viscosidade ou superfícies super-hidrofóbicas teóricas perfeitas.",
      "Está incorreta: inverte completamente a hidrodinâmica clássica do perfil de Poiseuille.",
      "Está incorreta: descreveria a formação instantânea de trombos estáticos oclusivos em todos os vasos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é anatomicamente absurda; a veia cava é o tronco venoso mestre do corpo.",
      "Está incorreta: confunde resistência química do poliuretano com temperatura corporal.",
      "Está incorreta: contém um erro crasso de rota anatómica (a veia cava desagua no átrio DIREITO, não esquerdo)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde hipertrofia vascular adaptativa com metaplasia tecidual impossível.",
      "Está incorreta: é uma complicação rara grave de isquemia distal ('roubo da fístula'), mas não o resultado normal esperado da cirurgia.",
      "Está incorreta: violaria a biofísica hemodinâmica global."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde solução salina eletrolítica com nutrientes energéticos metabolizáveis como a glicose.",
      "Está incorreta: violaria os princípios de evaporação e equilíbrio térmico fisiológico.",
      "Está incorreta: confunde glóbulos vermelhos com macrófagos e inventa fagocitose de líquidos infinitos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: violaria o Segundo Princípio da Termodinâmica gerando trabalho do nada.",
      "Está incorreta: ignora a viscosidade universal presente em todos os fluidos biológicos reais.",
      "Está incorreta: viola a Teoria da Relatividade Restrita de Einstein."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a pressão venosa com a pressão arterial sistólica do circuito sistémico de alta pressão.",
      "Está incorreta: propõe uma pressão subatmosférica letal que colapsaria completamente as câmaras cardíacas direitas.",
      "Está incorreta: ignora a fisiologia da circulação venosa que exige uma pressão motora positiva residual para encher o coração."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: causaria hipotermia pulmonar grave e broncospasmo reativo fatal.",
      "Está incorreta: é absurda; o oxigénio líquido causaria queimaduras criogénicas destrutivas imediatas.",
      "Está incorreta: viola a física dos gases ideais administrados na ventilação."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: propõe intervalos de tempo aberrantes para a restauração do fluxo capilar.",
      "Está incorreta: confunde a circulação sanguínea imediata com o crescimento biológico crónico da queratina.",
      "Está incorreta: confunde perfusão microvascular com hiper-hidratação simples."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (16 mmHg) esqueceu-se de multiplicar pelo coeficiente biofísico 4 da equação clínica simplificada de Bernoulli.",
      "Está incorreta: (8 mmHg) multiplicou erroneamente a velocidade por 2 em vez de elevar ao quadrado.",
      "Está incorreta: (256 mmHg) elevou ao quadrado o produto (4 × 4)², distorcendo a ordem das operações matemáticas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a circulação venosa sistémica com a dinâmica do sistema nervoso central.",
      "Está incorreta: viola as leis da massa e gravitação universal.",
      "Está incorreta: inventa mecanismos eletromagnéticos fantasiosos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é termodinamicamente impossível num organismo vivo.",
      "Está incorreta: é uma fantasia sem suporte físico.",
      "Está incorreta: confunde trombose intravascular com ossificação ectópica patológica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (100 gts/min) resultaria de uma divisão incorreta do volume por 5 horas ou erro na conversão de tempo.",
      "Está incorreta: (12 gts/min) infundiria o soro em cerca de 14 horas, subdosando gravemente a hidratação do doente.",
      "Está incorreta: (125 gts/min) corresponde ao débito volumétrico em mL/hora (500 mL / 4 h = 125 mL/h), tendo o aluno confundido mL/h com gotas/minuto."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a anatomia e a fisiologia renal com a função hepatocitária.",
      "Está incorreta: é contrária à patologia aterosclerótica ou displasia fibromuscular que estenosa o lúmen vascular.",
      "Está incorreta: descreve colapso circulatório oposto ao quadro clássico de hipertensão refratária grave."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignora a base de comparação pressórica sistólica do teste hemodinâmico.",
      "Está incorreta: é uma medição antropométrica geométrica que nada avalia sobre a circulação sanguínea.",
      "Está incorreta: é um parâmetro bioquímico laboratorial desconectado da medição física no leito."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve uma oclusão total que causaria gangrena aguda em horas, não a insuficiência venosa crónica.",
      "Está incorreta: introduz velocidades aerodinâmicas inexistentes na biologia.",
      "Está incorreta: é uma distorção biológica sem sentido."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: afirma o oposto das leis de perfusão e retorno venoso de Guyton.",
      "Está incorreta: é um absurdo hematológico.",
      "Está incorreta: ignora a interação cardiopulmonar direta que ocorre no espaço fechado inextensível do mediastino torácico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: atribui ao sangue propriedades físicas fictícias e velocidades relativísticas impossíveis.",
      "Está incorreta: assume viscosidade nula, o que só ocorreria num superfluido hélio quântico a perto de zero Kelvin.",
      "Está incorreta: ignora os princípios fundamentais da conservação de massa e de energia da física clássica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a medição da temperatura axilar com a avaliação hemodinâmica da pressão com esfigmomanómetro.",
      "Está incorreta: provocaria hemólise maciça hipotónica intravascular fatal imediata.",
      "Está incorreta: causaria congestão cerebral perigosa, hipertensão intracraniana e asfixia mecânica."
    ],
    "nursingApplication": "O enfermeiro compreende que a extrema lentidão do sangue nos capilares é uma exigência biofísica vital para permitir o tempo necessário à difusão transcapilar de oxigénio, glicose e dióxido de carbono."
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é uma aberração pseudocientífica que ignora a Lei de Poiseuille e a dependência em r⁴.",
      "Está incorreta porque , pois a turbulência é precisamente a geradora física dos sopros e ruídos de Korotkoff.",
      "Está incorreta: inverte totalmente a realidade: a velocidade capilar é a mais lenta do sistema cardiovascular."
    ],
    "nursingApplication": "O enfermeiro compreende que a extrema lentidão do sangue nos capilares é uma exigência biofísica vital para permitir o tempo necessário à difusão transcapilar de oxigénio, glicose e dióxido de carbono."
  },
  {
