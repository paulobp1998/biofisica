...
const TOPIC_1_QUESTIONS = [
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque o repouso é apenas um dos dois estados possíveis de equilíbrio translacional; o MRU é igualmente compatível com ∑F = 0.",
      "Está incorreta porque no movimento circular existe aceleração centrípeta (variação contínua da direção da velocidade), o que exige uma força resultante centrípeta não nula.",
      "Está incorreta porque qualquer aceleração diferente de zero requer, pela 2.ª Lei de Newton (F = m·a), uma força resultante não nula."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (240 N) resulta de uma divisão incorreta da massa pela aceleração (120 / 0,5).",
      "Está incorreta: (600 N) resultaria se a aceleração fosse erroneamente considerada igual a metade da aceleração da gravidade (g/2).",
      "Está incorreta: (1200 N) multiplicaria a massa por 10 (cálculo de peso aproximado), ignorando a aceleração horizontal real especificada no problema."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque forças só se anulam se atuarem sobre o mesmo corpo (como duas forças opostas aplicadas a um mesmo bloco).",
      "Está incorreta porque a interação é rigorosamente simultânea e instantânea na mecânica clássica newtoniana.",
      "Está incorreta porque a intensidade de ambas é estritamente igual (|F_A->B| = |F_B->A|), independentemente de as massas dos corpos serem desiguais."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque o peso corporal do doente (F = m·g) é constante e não varia com a posição ou área de contacto.",
      "Está incorreta porque o atrito está presente e até agrava o cisalhamento tecidual, mas não é a razão da concentração de pressão.",
      "Está incorreta: é um absurdo físico: a aceleração da gravidade (g ≈ 9,8 m/s²) é uniforme em todo o leito."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque se P > N haveria aceleração para baixo (o doente afundaria o leito indefinidamente).",
      "Está incorreta: confunde a fórmula do atrito com a do peso e ignora que num leito horizontal sem forças laterais o atrito estático é nulo.",
      "Está incorreta: viola a condição vetorial de equilíbrio, que exige equilíbrio nulo em todos os eixos ortogonais simultaneamente (∑Fx = 0 e ∑Fy = 0)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (70 N) comete o erro clássico de somar algebricamente os módulos (30 + 40), o que só seria válido se as duas forças tivessem rigorosamente a mesma direção e o mesmo sentido.",
      "Está incorreta: (10 N) subtrai os módulos (40 - 30), o que só ocorreria se atuassem na mesma linha reta em sentidos rigorosamente opostos.",
      "Está incorreta: (1200 N) multiplica os valores dos módulos, o que não tem qualquer significado físico na determinação da resultante de forças."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque : a aceleração da gravidade (g) é constante e invariável com o estado de movimento no leito.",
      "Está incorreta: viola a conservação da massa newtoniana: a massa de um doente é invariável à escala das velocidades hospitalares.",
      "Está incorreta porque : a força normal N continua presente e igual ao peso perpendicular ao colchão durante o deslizamento."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde uma propriedade escalar da matéria com uma força vetorial, perpetuando o erro de senso comum de medir forças em kg.",
      "Está incorreta: inverte completamente os conceitos: a massa é constante em qualquer ponto do universo, enquanto o peso varia com a aceleração da gravidade local g.",
      "Está incorreta: atribui unidades totalmente erróneas (Pascal é unidade de pressão e Joule é de energia/trabalho)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque : se a resultante fosse não-nula, o membro aceleraria (F = m·a), deslocando-se e desalinhando os topos ósseos da fratura.",
      "Está incorreta: propõe uma relação arbitrária perigosa que provocaria tração excessiva e lesão neurológica ou vascular no membro.",
      "Está incorreta porque : sistemas de tração utilizam frequentemente cabos diagonais com componentes horizontais e verticais em simultâneo."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é fantasiosa: agulhas comuns de injeção são mecânicas e não utilizam eletricidade.",
      "Está incorreta porque : a penetração depende da pressão mecânica de cisalhamento pontual e não de alterações na pressão atmosférica.",
      "Está incorreta: não possui fundamento físico: os tecidos oferecem resistência mecânica à deformação e penetração."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: tem uma relação dimensional incorreta entre tempo e comprimento.",
      "Está incorreta: corresponde à unidade de momento angular ou ação física (kg·m²/s).",
      "Está incorreta: define a Dina (dyn), unidade de força do antigo sistema CGS (1 dyn = 10⁻⁵ N)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: divide por 10 em vez de multiplicar pela potência 10⁵.",
      "Está incorreta: multiplica apenas por 10, esquecendo a ordem de grandeza do fator 10⁵.",
      "Está incorreta: multiplica por 10⁻⁵, que seria a conversão inversa (de dinas para Newtons)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é absurda: a gravidade é a mesma independentemente do volume da seringa.",
      "Está incorreta: confunde a reologia do polímero com a transmissão mecânica de pressão nos fluidos.",
      "Está incorreta: é uma ficção que mistura eletrostática com mecânica clássica de fluidos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (640 Pa) resultaria da multiplicação incorreta de 800 por 0,8.",
      "Está incorreta: (10 000 Pa) erra a ordem de grandeza da divisão decimal.",
      "Está incorreta: confunde a operação e adiciona zeros sem base matemática."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: assume erroneamente que 1 mmHg é igual a 1 Pa.",
      "Está incorreta: divide 133,3 por 32 em vez de multiplicar.",
      "Está incorreta: multiplica 133,3 por 1000, ignorando o valor de 32 mmHg."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve o comportamento do cosseno (que diminui), e não da componente tangencial (seno).",
      "Está incorreta: viola a decomposição trigonométrica dos vetores newtonianos.",
      "Está incorreta: é fisicamente absurda: cos θ varia entre 1 e 0, sendo N sempre finita e decrescente."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (30 N) subtrai os módulos, o que só ocorreria se os enfermeiros puxassem em sentidos opostos (forças antagónicas).",
      "Está incorreta: (27 000 N) multiplica os valores, o que não traduz composição vetorial.",
      "Está incorreta: divide os valores, sem base na mecânica newtoniana."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: soma as forças, ignorando que possuem sentidos opostos.",
      "Está incorreta: assume anulação mútua, o que só ocorreria se ambas tivessem rigorosamente o mesmo módulo (180 N e 180 N).",
      "Está incorreta: atribui a intensidade da força menor no sentido oposto ao vetor resultante real."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a unidade de massa (kg) com a unidade de peso (Newton), assumindo g = 1 m/s².",
      "Está incorreta: divide a massa pela gravidade (65 / 9,8).",
      "Está incorreta: multiplica por 98 m/s², cometendo um erro de vírgula decimal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: influencia fortemente o coeficiente de atrito (diferentes pares de materiais têm diferentes valores de μ).",
      "Está incorreta: influencia decisivamente o atrito (superfícies húmidas ou maceradas alteram radicalmente o atrito com a pele).",
      "Está incorreta: altera diretamente o atrito (lubrificantes criam camadas fluidas que reduzem o coeficiente μ)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde com sistemas complexos de cadernais compostos ou talhas exponenciais.",
      "Está incorreta porque : a massa do peso é constante e invariável.",
      "Está incorreta: viola a conservação da energia e a dinâmica das roldanas ideais."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: violaria a conservação da energia (o atrito nunca adiciona força útil ao sistema).",
      "Está incorreta: apresentam afirmações exageradas e sem fundamento físico.",
      "Está incorreta: apresentam afirmações exageradas e sem fundamento físico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde vantagem mecânica de força com desvantagem.",
      "Está incorreta porque : a roldana móvel é uma das máquinas simples fundamentais da física clássica.",
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve vetores contidos no próprio plano ou paralelos a ele.",
      "Está incorreta: ocorreria apenas se a cama estivesse inclinada a 45°.",
      "Está incorreta: descreve vetores colineares de sentidos contrários."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é absurda: a aceleração gravitacional não é alterada pelo material do colchão.",
      "Está incorreta: refere o atrito no ar, que tem influência nula na compressão capilar sacral.",
      "Está incorreta: inventa um fenómeno nuclear sem relação com colchões hospitalares."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: multiplica e divide os módulos, o que não reflete cálculo vetorial.",
      "Está incorreta: (10 N) corresponde exclusivamente ao caso particular de perpendicularidade (90°).",
      "Está incorreta: calcula a média aritmética simples, ignorando a dependência angular vetorial."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: referem propriedades óticas e termodinâmicas sem relação com o princípio da inércia mecânica.",
      "Está incorreta: referem propriedades óticas e termodinâmicas sem relação com o princípio da inércia mecânica.",
      "Está incorreta: referem propriedades óticas e termodinâmicas sem relação com o princípio da inércia mecânica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde com a relação entre força centrípeta e velocidade linear.",
      "Está incorreta: só ocorreria se a massa pudesse ser uma grandeza negativa, o que não existe na física clássica.",
      "Está incorreta: viola a causalidade newtoniana da dinâmica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a velocidade constante (1,2 m/s) com a aceleração (m/s²).",
      "Está incorreta: confunde a cinemática horizontal livre com a queda livre gravitacional vertical.",
      "Está incorreta: inventa valores sem nexo matemático com as condições de velocidade constante."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignoram a proporcionalidade direta linear estabelecida pelas leis do atrito.",
      "Está incorreta porque : maior força de contacto intensifica as interações microscópicas entre superfícies.",
      "Está incorreta porque : maior força de contacto intensifica as interações microscópicas entre superfícies."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inverte a orientação geométrica dos vetores perpendicular e tangencial.",
      "Está incorreta: confunde posturas corporais com a definição física de tensões mecânicas.",
      "Está incorreta: confunde forças de contacto mecânico com magnetismo molecular."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve o oposto: a oclusão capilar causa hipóxia e morte celular, não hiperoxigenação.",
      "Está incorreta: refere miosite ossificante heterotópica, que não é a fisiopatologia das úlceras por pressão.",
      "Está incorreta: é uma afirmação sem base na biologia de tecidos vivos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: define o Watt (W), unidade de potência (J/s).",
      "Está incorreta: é a massa linear (kg/m).",
      "Está incorreta: mistura força com volume, não correspondendo a pressão."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: implicaria uma resultante não-nula com aceleração do corpo.",
      "Está incorreta: não correspondem a métodos geométricos de adição de vetores discretos.",
      "Está incorreta: não correspondem a métodos geométricos de adição de vetores discretos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignora a dependência direta da força normal N.",
      "Está incorreta: inverte a relação física de dependência da massa.",
      "Está incorreta: é contrária às leis da física (maior massa aumenta a força normal e o atrito)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: multiplica 400 por 0,008 em vez de dividir.",
      "Está incorreta: erram por fatores de 10 e 100 na divisão decimal.",
      "Está incorreta: erram por fatores de 10 e 100 na divisão decimal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descrevem corpos em movimento e aceleração, incompatíveis com a imobilidade estática do doente.",
      "Está incorreta: utiliza terminologia inadequada para descrever o atrito com o colchão ao ar livre.",
      "Está incorreta: utiliza terminologia inadequada para descrever o atrito com o colchão ao ar livre."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inverte as definições fundamentais.",
      "Está incorreta: apresentam critérios arbitrários e erróneos.",
      "Está incorreta: apresentam critérios arbitrários e erróneos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: perpetua a conceção errónea comum de que materiais inanimados não exercem forças de reação.",
      "Está incorreta: propõem relações numéricas desprovidas de fundamentação na mecânica clássica.",
      "Está incorreta: propõem relações numéricas desprovidas de fundamentação na mecânica clássica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: reduz o tempo de exposição à pressão em cada ponto ósseo específico.",
      "Está incorreta: reduz a força e a pressão mecânica nos calcanhares para zero absoluto ao deixá-los suspensos.",
      "Está incorreta: aumenta a área A diminuindo a pressão tecidual P."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (40 N) assumiria ângulo de 0° (mesmo sentido).",
      "Está incorreta: (0 N) assumiria ângulo de 180° (sentidos opostos colineares).",
      "Está incorreta: multiplica os módulos sem relação com a geometria vetorial."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: comete o erro clássico de confundir a força normal com a reação ao peso (atuam no mesmo corpo e têm origens físicas diferentes).",
      "Está incorreta: apresentam explicações falsas sem base na física clássica.",
      "Está incorreta: apresentam explicações falsas sem base na física clássica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde o coeficiente de atrito com a força de atrito (que se mede em Newton).",
      "Está incorreta: é a unidade de pressão.",
      "Está incorreta: é a unidade de velocidade linear."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve movimento relativo com atrito cinético (μ_c · N), que é menor que o estático máximo.",
      "Está incorreta: não tem superfícies sólidas em contacto, logo o atrito de superfície é nulo.",
      "Está incorreta: representa atrito estático nulo (F_atrito_e = 0), pois não há força paralela a tentar mover o corpo."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (20 N/m) esqueceu a conversão de centímetros para metros (100 / 5).",
      "Está incorreta: (500 N/m) resulta da multiplicação de 100 por 5.",
      "Está incorreta: não reflete o cálculo da constante elástica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (800 N) é o peso total do doente.",
      "Está incorreta: (450 N) assumiria distribuição simétrica que totalizaria 900 N.",
      "Está incorreta: (1250 N) somaria 800 com 450 incorretamente."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: cometem erros de cálculo na conversão de mm² para m² (1 mm² = 10⁻⁶ m²).",
      "Está incorreta: cometem erros de cálculo na conversão de mm² para m² (1 mm² = 10⁻⁶ m²).",
      "Está incorreta: cometem erros de cálculo na conversão de mm² para m² (1 mm² = 10⁻⁶ m²)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque : a gravidade atua permanentemente enquanto o corpo tiver massa no campo terrestre.",
      "Está incorreta porque : a massa é um escalar positivo constante.",
      "Está incorreta porque : a pressão arterial mantém-se dinâmica no ciclo cardíaco."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: corresponde à pressão arterial sistólica sistémica nas grandes artérias.",
      "Está incorreta: é demasiado baixa (pressão no átrio direito / PVC normal varia entre 2 a 6 mmHg).",
      "Está incorreta: corresponde à pressão atmosférica ao nível do mar (760 mmHg)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inverte as projeções quando o ângulo θ é definido com o eixo horizontal.",
      "Está incorreta: apresentam operações matematicamente incorretas na projeção vetorial.",
      "Está incorreta: apresentam operações matematicamente incorretas na projeção vetorial."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde variáveis termodinâmicas escalares com a definição mecânica de vetor de força.",
      "Está incorreta porque , pois forças exigem soma vetorial (regra do paralelogramo ou decomposição trigonométrica em componentes ortogonais).",
      "Está incorreta porque , pois as forças musculares, articulares e gravíticas no corpo humano são todos vetores clássicos da física newtoniana."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (kg·m²/s) corresponde às unidades de momento angular no SI.",
      "Está incorreta: (kg/m·s²) corresponde à unidade de pressão mecânica, o Pascal (Pa).",
      "Está incorreta: é uma combinação dimensional sem significado físico reconhecido."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (70 N) é a soma escalar direta (30 + 40), que só ocorreria se ambas as forças atuassem rigorosamente na mesma direção e no mesmo sentido (ângulo de 0°).",
      "Está incorreta: (10 N) seria a resultante se atuassem na mesma direção mas com sentidos opostos (ângulo de 180°).",
      "Está incorreta: (1200 N) é a multiplicação incorreta dos módulos das forças."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é uma força, logo é uma grandeza vetorial com direção e sentido definidos.",
      "Está incorreta: é aceleração, grandeza vetorial correspondente à taxa de variação temporal do vetor velocidade.",
      "Está incorreta: é a velocidade vetorial, que exige especificação do rumo e orientação do movimento."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (100 N) só ocorreria se ambas as forças atuassem no mesmo sentido.",
      "Está incorreta: ignora o efeito de anulação mútua exercido pela força oposta de intensidade idêntica.",
      "Está incorreta: representa uma multiplicação incorreta de grandezas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (86,6 N) calcula a componente vertical Fy = F · sen(60°), não a componente horizontal.",
      "Está incorreta: utiliza erroneamente a tangente, que relaciona os catetos e não a hipotenusa da força.",
      "Está incorreta: divide arbitrariamente o módulo pelo ângulo em graus, violando a trigonometria elementar."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: refere-se a propriedades químicas nucleares que não deformam molas mecânicas.",
      "Está incorreta: é mensurada por termómetros clínicos de infravermelhos ou de resistência.",
      "Está incorreta: é avaliada por métodos de diluição isotópica ou hematócrito, não por dinamometria."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: define vetores perpendiculares ou ortogonais, não colineares.",
      "Está incorreta porque , pois podem atuar em corpos diferentes ou no mesmo sentido.",
      "Está incorreta: é uma afirmação sem sentido físico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde comprimento geométrico vetorial com duração temporal escalar.",
      "Está incorreta: confunde a força resultante com a inércia do corpo (massa).",
      "Está incorreta: refere-se a uma propriedade reológica dos tecidos sem relação com o desenho do vetor."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde kgf com Newton, esquecendo a aceleração da gravidade.",
      "Está incorreta: inverte a relação (1 N ≈ 0,102 kgf).",
      "Está incorreta: multiplica por 100 de forma incorreta (confundindo com dinas do sistema CGS)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: somaria os módulos se ambos apontassem para o mesmo lado.",
      "Está incorreta: atribui o sentido da força menor, o que viola o balanço vetorial.",
      "Está incorreta: só seria verdadeira se ambas as forças tivessem rigorosamente a mesma magnitude."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contém apenas grandezas escalares (massa, temperatura, volume, pressão).",
      "Está incorreta: mistura escalares (tempo, energia, densidade) com um vetor (força).",
      "Está incorreta: inclui escalares fisiológicos e geométricos (frequência cardíaca, área, comprimento)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: referem-se a processos farmacológicos, eletrofisiológicos e nefrológicos sem qualquer ligação à geometria vetorial newtoniana.",
      "Está incorreta: referem-se a processos farmacológicos, eletrofisiológicos e nefrológicos sem qualquer ligação à geometria vetorial newtoniana.",
      "Está incorreta: referem-se a processos farmacológicos, eletrofisiológicos e nefrológicos sem qualquer ligação à geometria vetorial newtoniana."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve uma força puramente horizontal ao longo do eixo X.",
      "Está incorreta: teria módulo √(10² + 10²) = 14,14 N inclinada a 45°.",
      "Está incorreta: aponta no sentido negativo do eixo Y (para baixo)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (20 J) é a divisão incorreta da força pela distância (40 / 2).",
      "Está incorreta: (42 J) é a soma sem sentido físico de Newtons com metros.",
      "Está incorreta: (1600 J) é o quadrado da força."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a resistência ao escoamento em fluidos.",
      "Está incorreta: é a energia associada ao estado de movimento (½ m v²).",
      "Está incorreta: é a força coesiva na superfície livre de líquidos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola a inércia; nenhum corpo com massa para instantaneamente sem a ação de forças imensas.",
      "Está incorreta: inventa uma aceleração vertical sem fundamento na física do movimento linear longitudinal.",
      "Está incorreta: confunde travagem com uma aceleração para a frente (arranque brusco)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde velocidade constante com aceleração unitária de 1 m/s².",
      "Está incorreta: confunde a força resultante horizontal com a aceleração da gravidade.",
      "Está incorreta: calcula o peso aproximado e atribui-o erradamente à resultante do movimento horizontal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde ausência de força resultante com ausência total de forças individuais.",
      "Está incorreta: causaria aceleração do frasco para o solo, rasgando o gancho.",
      "Está incorreta: viola a definição física de repouso no referencial do quarto."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inventam conceitos esotéricos e violações absurdas das leis da gravitação.",
      "Está incorreta: confunde reflexos posturais neurológicos secundários com a causa física primária que é a inércia newtoniana.",
      "Está incorreta: confunde reflexos posturais neurológicos secundários com a causa física primária que é a inércia newtoniana."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola a definição básica de mecânica clássica.",
      "Está incorreta: confunde uma variável fisiológica com a propriedade fundamental da matéria.",
      "Está incorreta porque , pois a inércia depende criticamente da massa."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a visão pré-newtoniana aristotélica errónea (teoria do ímpeto), refutada há séculos pela ciência.",
      "Está incorreta: são afirmações estapafúrdias sem conexão com a física clássica.",
      "Está incorreta: são afirmações estapafúrdias sem conexão com a física clássica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: refere-se à gravidade na queda livre, incompatível com equilíbrio de forças.",
      "Está incorreta: introduz uma variável termodinâmica irrelevante para a soma vetorial de forças.",
      "Está incorreta: é um disparate físico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde gravidade vertical com efeitos inerciais na direção horizontal.",
      "Está incorreta: confunde hemodinâmica com cinemática de massas aceleradas.",
      "Está incorreta: é uma afirmação sem sentido."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola a teoria da relatividade e a constância da velocidade da luz no vácuo.",
      "Está incorreta: descreve referenciais não inerciais acelerados.",
      "Está incorreta porque , pois referenciais inerciais podem existir na presença de campos gravíticos uniformes se considerarmos a equivalência local."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde peso (força vertical) com força propulsora horizontal num ambiente sem atrito.",
      "Está incorreta: mistura unidades de força com metade de uma massa escalar.",
      "Está incorreta: ignora a definição fundamental da Lei da Inércia."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inventa um magnetismo inexistente entre fluidos corporais e pavimentos vinílicos.",
      "Está incorreta: são disparates químicos sem qualquer base física.",
      "Está incorreta: são disparates químicos sem qualquer base física."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve uma queda livre acelerada sob a gravidade.",
      "Está incorreta: descreve equilíbrio rotacional dinâmico ou rotação livre.",
      "Está incorreta: descreve um corpo com aceleração não nula pela 2.ª Lei de Newton."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde circuitos elétricos com mecânica translacional de massas.",
      "Está incorreta: confunde a resposta de pânico autonómica com a cinemática física do corpo.",
      "Está incorreta porque , pois a sensação tem base mecânica inercial perfeitamente mensurável por acelerómetros."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde peso nulo (ausência de suporte da gravidade) com massa inercial nula.",
      "Está incorreta: inventa um efeito inexistente entre gases respiráveis e a inércia de massas sólidas.",
      "Está incorreta: confunde mecânica newtoniana com fissão/fusão nuclear quântica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (1,25 m/s²) inverte a fração, dividindo a massa pela força (100 / 80).",
      "Está incorreta: (8,0 m/s²) comete um erro de cálculo decimal por fator de 10.",
      "Está incorreta: (8000 m/s²) multiplica a massa pela força em vez de dividir."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: diminuiria a aceleração para um quarto da inicial.",
      "Está incorreta: confunde a proporcionalidade linear da 2.ª Lei com uma relação quadrática.",
      "Está incorreta: nega a 2.ª Lei de Newton, segundo a qual a massa é a medida da inércia."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (1 m/s²) calcula simplesmente v / Δs.",
      "Está incorreta: (4 m/s²) esquece-se do fator 2 no denominador da equação de Torricelli.",
      "Está incorreta: (0,5 m/s²) inverte o cálculo cinemático."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (75 N) resulta de dividir a massa pela aceleração (150 / 2).",
      "Está incorreta: (150 N) multiplicaria por 1 m/s² em vez de 2 m/s².",
      "Está incorreta: (600 N) multiplicaria pelo quadrado da aceleração."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde força com potência mecânica (dW/dt).",
      "Está incorreta: refere-se à taxa de variação de um campo potencial que define gradiente, não derivada temporal.",
      "Está incorreta: confunde uma grandeza da mecânica geral com um parâmetro hemodinâmico ventricular."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: só ocorre quando a força resultante é rigorosamente zero (∑F = 0).",
      "Está incorreta: contraria a 2.ª Lei, pois forças resultantes aceleram corpos.",
      "Está incorreta: exigiria forças periódicas variáveis proporcionais ao deslocamento (movimento harmónico simples)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (0,6 m/s²) esquece de subtrair o atrito (120 / 200 = 0,6).",
      "Está incorreta: (0,7 m/s²) considera apenas a força do primeiro enfermeiro sem atrito.",
      "Está incorreta: (1,0 m/s²) divide a força de atrito pela massa de forma incoerente."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: divide a massa pela aceleração (10 / 3) e erra o sentido.",
      "Está incorreta: inverte a divisão (3 / 10).",
      "Está incorreta: multiplica pelo quadrado da aceleração."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (50 N) multiplica a massa pela velocidade final (5 × 10), que é o momento linear, não a força.",
      "Está incorreta: (10 N) confunde a força com o valor numérico da velocidade.",
      "Está incorreta: (100 N) duplica erradamente os fatores."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: violaria as leis fundamentais do cálculo e da dinâmica clássica.",
      "Está incorreta: confunde ausência de força resultante com presença da aceleração gravítica g.",
      "Está incorreta: não possui fundamentação matemática na física real."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (784 N) é apenas o peso estático do doente em repouso (80 × 9,8).",
      "Está incorreta: (704 N) seria o valor se o guindaste estivesse a desacelerar ou a descer de forma acelerada.",
      "Está incorreta: (80 N) é apenas a força inercial m·a isolada."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (864 N) ocorre na subida acelerada.",
      "Está incorreta: (784 N) ocorre em repouso ou velocidade constante de descida.",
      "Está incorreta: (0 N) só ocorreria se o cabo partisse e o doente estivesse em queda livre (a = g)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: relacionam variáveis metabólicas termodinâmicas sem ligação ao produto força-tempo.",
      "Está incorreta: confunde impulso (vetor em N·s) com trabalho mecânico (escalar em Joules).",
      "Está incorreta: confunde impulso (vetor em N·s) com trabalho mecânico (escalar em Joules)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: divide a força pelo tempo (20 / 3).",
      "Está incorreta: combinam incorretamente a área em cm² com o cálculo temporal.",
      "Está incorreta: combinam incorretamente a área em cm² com o cálculo temporal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (120 N) divide por 1 segundo em vez de 0,1 s.",
      "Está incorreta: (400 N) multiplicaria a massa por 10.",
      "Está incorreta: (12 N) erra a ordem de grandeza por divisão indevida."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a biologia muscular ativa com as leis universais da física newtoniana que regem toda a matéria.",
      "Está incorreta: inverte o sentido da força de reação normal e de atrito.",
      "Está incorreta: nega a 3.ª Lei de Newton e tornaria a marcha humana impossível."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola a igualdade estrita dos módulos das forças do par (F_AB = -F_BA).",
      "Está incorreta porque , pois a interação de contacto na mecânica clássica é rigorosamente simultânea.",
      "Está incorreta: contraria a definição básica de sentidos opostos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: violam a 3.ª Lei de Newton, que exige igualdade estrita e absoluta de intensidades.",
      "Está incorreta: violam a 3.ª Lei de Newton, que exige igualdade estrita e absoluta de intensidades.",
      "Está incorreta: violam a 3.ª Lei de Newton, que exige igualdade estrita e absoluta de intensidades."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignora a incompressibilidade dos líquidos que transmitem a resistência por pressão.",
      "Está incorreta: violam a 3.ª Lei de Newton.",
      "Está incorreta: violam a 3.ª Lei de Newton."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde equilíbrio estático de duas forças no mesmo corpo com a 3.ª Lei de Newton.",
      "Está incorreta: é errónea, pois o par de ação e reação requer corpos diferentes e a mesma natureza de interação.",
      "Está incorreta: nega a existência da força normal de sustentação da mesa."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde deformação mecânica tecidual com ausência de força de reação física.",
      "Está incorreta: viola a igualdade matemática estrita dos módulos do par de ação-reação.",
      "Está incorreta: inventa uma amplificação de força que violaria as leis de conservação da mecânica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignora a ausência de atrito suficiente no piso para impedir o recuo se os travões estiverem soltos.",
      "Está incorreta: violaria o sentido oposto estrito da força de reação.",
      "Está incorreta: inventa uma componente vertical impossível no plano horizontal."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: sugere uma atração prévia inexistente.",
      "Está incorreta: viola o princípio da conservação da quantidade de movimento e da energia.",
      "Está incorreta: ignora que qualquer material sólido transmite forças newtonianas de contacto."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: desconsideram a natureza eletrostática de contacto da força normal e a igualdade dos pares newtonianos.",
      "Está incorreta: desconsideram a natureza eletrostática de contacto da força normal e a igualdade dos pares newtonianos.",
      "Está incorreta: desconsideram a natureza eletrostática de contacto da força normal e a igualdade dos pares newtonianos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é o erro clássico: Peso e Normal atuam ambos sobre o mesmo corpo (o doente).",
      "Está incorreta: relaciona duas forças aplicadas em pontos distintos com causas físicas diferentes.",
      "Está incorreta: relaciona dois valores temporais extremos de pressão num ciclo pulsátil cardíaco."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignoram o comportamento elástico da borracha e a 3.ª Lei de Newton.",
      "Está incorreta: ignoram o comportamento elástico da borracha e a 3.ª Lei de Newton.",
      "Está incorreta: ignoram o comportamento elástico da borracha e a 3.ª Lei de Newton."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são afirmações absurdas sem nexo biológico ou mecânico.",
      "Está incorreta: são afirmações absurdas sem nexo biológico ou mecânico.",
      "Está incorreta: são afirmações absurdas sem nexo biológico ou mecânico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: introduzem fenómenos imaginários sem fundamento na mecânica dos fluidos e de contacto.",
      "Está incorreta: introduzem fenómenos imaginários sem fundamento na mecânica dos fluidos e de contacto.",
      "Está incorreta: introduzem fenómenos imaginários sem fundamento na mecânica dos fluidos e de contacto."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: atribuem a dor a causas térmicas, elétricas ou hematológicas fictícias no impacto mecânico elástico.",
      "Está incorreta: atribuem a dor a causas térmicas, elétricas ou hematológicas fictícias no impacto mecânico elástico.",
      "Está incorreta: atribuem a dor a causas térmicas, elétricas ou hematológicas fictícias no impacto mecânico elástico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde os lados da corda com forças que se anulam no eixo da polia.",
      "Está incorreta: esquece uma das tensões da corda.",
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde equilíbrio estático em repouso com escoamento em queda livre com resistência do ar.",
      "Está incorreta: geraria aceleração vertical para baixo, violando a condição de repouso.",
      "Está incorreta: introduz uma variável barométrica irrelevante para a mecânica estática."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a massa em kg com a força em Newtons.",
      "Está incorreta: multiplica erroneamente por 100.",
      "Está incorreta: divide por 10 em vez de multiplicar pela gravidade."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria uma prática perigosa e asfixiante que viola as boas práticas clínicas.",
      "Está incorreta: são ideias absurdas sem fundamentação científica.",
      "Está incorreta: são ideias absurdas sem fundamentação científica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (70 N) é a soma escalar ingénua que ignora a ortogonalidade dos vetores.",
      "Está incorreta: (10 N) seria a subtração das componentes.",
      "Está incorreta: (1200 N) é o produto das intensidades."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: violaria a conservação da energia; atrito dissipa energia, nunca amplifica forças passivas.",
      "Está incorreta: contrariam a mecânica clássica e a fisiologia da consolidação óssea.",
      "Está incorreta: contrariam a mecânica clássica e a fisiologia da consolidação óssea."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: provocaria necrose térmica óssea e queimaduras teciduais graves.",
      "Está incorreta: destruiria a estabilidade mecânica do pino, lesando tecido ósseo e partes moles.",
      "Está incorreta: causaria dor intolerável, destruição do foco de fratura e hemorragia maciça."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria uma desvantagem absurda.",
      "Está incorreta: descreve a roldana fixa simples (VM = 1), que apenas muda a direção da força.",
      "Está incorreta: inventa o movimento perpétuo violando a primeira lei da termodinâmica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta porque ; pelo contrário, colares demasiado apertados podem comprimir as jugulares e aumentar a pressão intracraniana.",
      "Está incorreta: não têm suporte na biomecânica ou hemodinâmica do colar cervical.",
      "Está incorreta: não têm suporte na biomecânica ou hemodinâmica do colar cervical."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde concentração de força com alívio pressórico.",
      "Está incorreta: é fisiopatologicamente falsa; a compressão mecânica oclui vasos linfáticos e venosos, gerando edema distal.",
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: resultaria num vetor resultante não-nulo de R = √(10² + 10²) ≈ 14,14 N a 45°, gerando aceleração.",
      "Está incorreta: contrariam a álgebra vetorial fundamental de Newton.",
      "Está incorreta: contrariam a álgebra vetorial fundamental de Newton."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde estabilização mecânica de fraturas com termoterapia ativa.",
      "Está incorreta: é um efeito adverso gravíssimo a evitar, e não o objetivo primário.",
      "Está incorreta porque ; a tala previne a hemorragia contínua na coxa, mas não substitui hemoderivados perdidos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contrariam as leis básicas da estática de cabos e polias.",
      "Está incorreta: contrariam as leis básicas da estática de cabos e polias.",
      "Está incorreta: contrariam as leis básicas da estática de cabos e polias."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (30 N) seria a resposta se as cordas fossem estritamente verticais e paralelas (ângulo de 0° entre si).",
      "Está incorreta: ignoram o efeito trigonométrico da inclinação das cordas.",
      "Está incorreta: ignoram o efeito trigonométrico da inclinação das cordas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confundem translação pura do centro de massa com dinâmica rotacional de corpos extensos.",
      "Está incorreta: mistura termodinâmica com a mecânica clássica de torques.",
      "Está incorreta: mistura termodinâmica com a mecânica clássica de torques."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são invenções absurdas sem cabimento científico.",
      "Está incorreta: são invenções absurdas sem cabimento científico.",
      "Está incorreta: são invenções absurdas sem cabimento científico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inverte os conceitos: o peso é que varia com a gravidade local (altitude, latitude ou outro planeta) e a massa é constante.",
      "Está incorreta: inverte as unidades do Sistema Internacional.",
      "Está incorreta: é o erro popular comum na linguagem quotidiana, mas inaceitável na biofísica médica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde o número da massa em kg com o valor da força peso em Newtons.",
      "Está incorreta: divide a massa pela gravidade (65 / 9,8).",
      "Está incorreta: multiplica erradamente por um fator de 10 adicional."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ocorreria apenas se o elevador estivesse em queda livre acelerada para baixo com a = g.",
      "Está incorreta: confunde a constância da massa com a variação dinâmica da força normal de apoio em referenciais acelerados.",
      "Está incorreta: é uma situação fisicamente impossível no movimento mecânico real."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde desaceleração no topo com aceleração na base.",
      "Está incorreta: são alegações sem fundamento físico ou fisiológico.",
      "Está incorreta: são alegações sem fundamento físico ou fisiológico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria a leitura de um dinamómetro de mola calibrado para a gravidade da Terra, que mede peso e não compara massas diretamente.",
      "Está incorreta: demonstram desconhecimento do princípio das alavancas de pesagem.",
      "Está incorreta: demonstram desconhecimento do princípio das alavancas de pesagem."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: troca incorretamente as unidades de massa (kg) e força peso (N).",
      "Está incorreta: multiplica a gravidade por 100 de forma errada.",
      "Está incorreta: ignora que a retenção de líquidos acrescenta matéria real e peso mensurável ao organismo."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: violam a lei fundamental da gravitação formulada por Newton em 1687.",
      "Está incorreta: violam a lei fundamental da gravitação formulada por Newton em 1687.",
      "Está incorreta: violam a lei fundamental da gravitação formulada por Newton em 1687."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: introduzem alterações absurdas nas propriedades fundamentais da matéria.",
      "Está incorreta: introduzem alterações absurdas nas propriedades fundamentais da matéria.",
      "Está incorreta: introduzem alterações absurdas nas propriedades fundamentais da matéria."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde a massa em kg com a força peso em Newtons.",
      "Está incorreta: multiplica os gramas pela gravidade sem converter para kg no SI.",
      "Está incorreta: (4,9 N) consideraria uma densidade de 1,0 g/mL (água pura)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignoram que a gravidade externa não muda com a postura do indivíduo.",
      "Está incorreta: ignoram que a gravidade externa não muda com a postura do indivíduo.",
      "Está incorreta: ignoram que a gravidade externa não muda com a postura do indivíduo."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde derivada temporal com gradiente espacial de distância.",
      "Está incorreta: descreve uma velocidade constante, o que implicaria aceleração nula.",
      "Está incorreta: descreve uma desaceleração negativa."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: multiplica os gramas diretamente sem converter para o SI (1500 × 9,8).",
      "Está incorreta: confunde a massa em kg com a força em Newtons.",
      "Está incorreta: erra a conversão de escala por fator de 100."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: comete um erro decimal por fator de 10 (considerando 0,25 kg).",
      "Está incorreta: não converte gramas para quilogramas.",
      "Está incorreta: confunde massa em gramas com Newtons."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confundem uma definição mecânica translacional com glândulas endócrinas ou estruturas de condução cardíaca.",
      "Está incorreta: é uma afirmação sem sentido físico.",
      "Está incorreta: é uma afirmação sem sentido físico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é o clássico erro aristotélico refutado por Galileu.",
      "Está incorreta: inventa uma imunidade gravítica fictícia para materiais leves.",
      "Está incorreta: confunde ausência de ar (vácuo) com ausência de campo gravitacional."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a força peso de atração da Terra, e não a força normal de contacto.",
      "Está incorreta: são forças nucleares subatómicas que atuam exclusivamente dentro do núcleo atómico a distâncias inferiores a 10⁻¹⁵ m.",
      "Está incorreta: são forças nucleares subatómicas que atuam exclusivamente dentro do núcleo atómico a distâncias inferiores a 10⁻¹⁵ m."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      ...
      "Está incorreta: introduz uma dependência quadrática incorreta.",
      "Está incorreta: é a equação dos gases ideais de Clapeyron da termodinâmica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contraria toda a experiência prática e teórica da tribologia mecânica.",
      "Está incorreta: ignora a quebra das microssoldaduras moleculares durante o movimento.",
      "Está incorreta: é uma situação irreal que só existiria em superfluidos a temperaturas próximas do zero absoluto."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confunde agressão mecânica aguda com processo cicatricial tardio.",
      "Está incorreta: são alegações sem qualquer base fisiopatológica.",
      "Está incorreta: são alegações sem qualquer base fisiopatológica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: divide por 10 de forma errada.",
      "Está incorreta: ignora o coeficiente de atrito (considera μ = 1,0).",
      "Está incorreta: erra a casa decimal por fator de 10."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: atribuem propriedades mecânicas e eletrofisiológicas bizarras e indesejadas a telas de transferência plásticas.",
      "Está incorreta: atribuem propriedades mecânicas e eletrofisiológicas bizarras e indesejadas a telas de transferência plásticas.",
      "Está incorreta: atribuem propriedades mecânicas e eletrofisiológicas bizarras e indesejadas a telas de transferência plásticas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são afirmações absurdas sem relação com a mecânica da marcha e atrito de contacto.",
      "Está incorreta: são afirmações absurdas sem relação com a mecânica da marcha e atrito de contacto.",
      "Está incorreta: são afirmações absurdas sem relação com a mecânica da marcha e atrito de contacto."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a conceção intuitiva errada refutada pela tribologia clássica.",
      "Está incorreta: inventa um limite mínimo arbitrário.",
      "Está incorreta: é uma afirmação sem qualquer sentido físico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: tornaria a pele quebradiça, o que aumentaria as fissuras.",
      "Está incorreta: contrariam as leis da biologia celular e da hemodinâmica microvascular.",
      "Está incorreta: contrariam as leis da biologia celular e da hemodinâmica microvascular."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (784 N) é o peso total do doente em leito estritamente horizontal (cos 0° = 1).",
      "Está incorreta: (392 N) é a componente paralela que puxa o doente para os pés da cama (P · sen 30° = 784 × 0,5).",
      "Está incorreta: só ocorreria se a cama estivesse vertical a 90° (parede)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é o peso total estático.",
      "Está incorreta: é a força normal perpendicular de compressão.",
      "Está incorreta: ignora a decomposição vetorial de forças da mecânica num plano inclinado."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: invocam forças físicas despropositadas no contexto biomecânico do leito.",
      "Está incorreta: invocam forças físicas despropositadas no contexto biomecânico do leito.",
      "Está incorreta: invocam forças físicas despropositadas no contexto biomecânico do leito."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: viola a física relativista de Einstein.",
      "Está incorreta: são justificações risíveis sem fundamento técnico.",
      "Está incorreta: são justificações risíveis sem fundamento técnico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: inverte o efeito lubrificante amplamente conhecido do sabão.",
      "Está incorreta: violam as leis da conservação de massa e gravitação.",
      "Está incorreta: violam as leis da conservação de massa e gravitação."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descrevem intervenções iatrogénicas danosas e absurdas.",
      "Está incorreta: descrevem intervenções iatrogénicas danosas e absurdas.",
      "Está incorreta: descrevem intervenções iatrogénicas danosas e absurdas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a definição de Débito Cardíaco (DC = VS × FC).",
      "Está incorreta: é a fórmula de Momento de uma força (Torque = F · d).",
      "Está incorreta: é uma combinação sem significado dimensional válido."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: ignora a densidade elevada do mercúrio (13,6 vezes superior à da água).",
      "Está incorreta: erram grosseiramente a escala de conversão barométrica.",
      "Está incorreta: erram grosseiramente a escala de conversão barométrica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a pressão arterial sistólica central nas grandes artérias elásticas.",
      "Está incorreta: é a pressão nas grandes veias cavas centrais.",
      "Está incorreta: representa pressões cavitárias extremas incompatíveis com a integridade capilar."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contradizem a fisiologia básica da isquemia e hipóxia celular tecidual.",
      "Está incorreta: contradizem a fisiologia básica da isquemia e hipóxia celular tecidual.",
      "Está incorreta: contradizem a fisiologia básica da isquemia e hipóxia celular tecidual."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: cometem erros grosseiros de unidades e de conversão de área (1 cm² = 0,0001 m², logo 10 cm² = 0,001 m²).",
      "Está incorreta: cometem erros grosseiros de unidades e de conversão de área (1 cm² = 0,0001 m², logo 10 cm² = 0,001 m²).",
      "Está incorreta: cometem erros grosseiros de unidades e de conversão de área (1 cm² = 0,0001 m², logo 10 cm² = 0,001 m²)."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: multiplicaria em vez de dividir pela área.",
      "Está incorreta: erra a conversão por um fator de mais de 10.",
      "Está incorreta: viola a conservação de força; o peso continua presente e a ser suportado."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: listam estruturas que não suportam carga de compressão no decúbito dorsal clássico.",
      "Está incorreta: listam estruturas que não suportam carga de compressão no decúbito dorsal clássico.",
      "Está incorreta: listam estruturas que não suportam carga de compressão no decúbito dorsal clássico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: indicam regiões que não recebem a carga compressiva do corpo em decúbito lateral.",
      "Está incorreta: indicam regiões que não recebem a carga compressiva do corpo em decúbito lateral.",
      "Está incorreta: indicam regiões que não recebem a carga compressiva do corpo em decúbito lateral."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: tem baixa taxa metabólica e células mortas queratinizadas resistentes à hipóxia.",
      "Está incorreta: são estruturas acelulares hipermineralizadas sem irrigação sanguínea direta.",
      "Está incorreta: são estruturas acelulares hipermineralizadas sem irrigação sanguínea direta."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: indicam áreas anatómicas sem sustentação de carga corporal na posição de sentado.",
      "Está incorreta: indicam áreas anatómicas sem sustentação de carga corporal na posição de sentado.",
      "Está incorreta: indicam áreas anatómicas sem sustentação de carga corporal na posição de sentado."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é refutada pela presença do extravasamento de sangue no espaço extravascular.",
      "Está incorreta: introduzem diagnósticos sem relação com a compressão mecânica hospitalar.",
      "Está incorreta: introduzem diagnósticos sem relação com a compressão mecânica hospitalar."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: agravaria o risco de lesão.",
      "Está incorreta: é um erro clínico gravíssimo: pensos profiláticos NUNCA dispensam o reposicionamento periódico do doente!",
      "Está incorreta: provocaria queimaduras e necrose tecidual."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são afirmações fantásticas sem respaldo na ciência dos materiais médicos.",
      "Está incorreta: são afirmações fantásticas sem respaldo na ciência dos materiais médicos.",
      "Está incorreta: são afirmações fantásticas sem respaldo na ciência dos materiais médicos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria uma catástrofe que provocaria embolia gasosa iatrogénica.",
      "Está incorreta: são disparates físicos sem conexão com a canulação venosa.",
      "Está incorreta: são disparates físicos sem conexão com a canulação venosa."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve a aplicação de um torniquete hemostático de combate para amputações traumáticas, inadequado para punções de rotina.",
      "Está incorreta: estragaria as amostras laboratoriais que requerem sangue não hemolisado e anticoagulado.",
      "Está incorreta: não corresponde aos efeitos hemodinâmicos do garrote."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: causaria queimaduras de segundo grau nos doentes.",
      "Está incorreta: anularia a principal vantagem da pressão alternada, comportando-se como uma superfície estática dura.",
      "Está incorreta: é uma invenção fantasiosa sem ligação à engenharia biomédica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são disparates físicos sem cabimento clínico.",
      "Está incorreta: são disparates físicos sem cabimento clínico.",
      "Está incorreta: são disparates físicos sem cabimento clínico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve um material dilatante de alta taxa de cisalhamento, oposto ao conforto viscoelástico.",
      "Está incorreta: não têm suporte na ciência dos biomateriais hospitalares.",
      "Está incorreta: não têm suporte na ciência dos biomateriais hospitalares."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a conceção leiga errada frequentemente encontrada em enfermarias que deve ser combatida.",
      "Está incorreta: ignoram a mecânica de membranas esticadas e a perda de conformabilidade superficial.",
      "Está incorreta: ignoram a mecânica de membranas esticadas e a perda de conformabilidade superficial."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são justificações absurdas sem fundamento biomecânico ou patológico.",
      "Está incorreta: são justificações absurdas sem fundamento biomecânico ou patológico.",
      "Está incorreta: são justificações absurdas sem fundamento biomecânico ou patológico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a 1.ª Lei da Termodinâmica.",
      "Está incorreta: inverte a 2.ª Lei da Termodinâmica.",
      "Está incorreta: mistura conceitos cinemáticos com equilíbrio hidrostático."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descreve 'bottoming out' lesivo.",
      "Está incorreta: criaria instabilidade postural perigosa com risco de queda.",
      "Está incorreta: ignora a biofísica da sustentação pneumática de fluidos."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descrevem tecnologias diferentes ou inventadas sem relação com camas fluidificadas.",
      "Está incorreta: descrevem tecnologias diferentes ou inventadas sem relação com camas fluidificadas.",
      "Está incorreta: descrevem tecnologias diferentes ou inventadas sem relação com camas fluidificadas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria uma imobilização violenta sem base física.",
      "Está incorreta: não têm relação com o alívio de cargas e aumentariam o risco de lesão tecidual.",
      "Está incorreta: não têm relação com o alívio de cargas e aumentariam o risco de lesão tecidual."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: sobrestimam perigosamente a eficácia mecânica da lã.",
      "Está incorreta porque ; pelo contrário, peles naturais mal desinfetadas podem acumular bactérias.",
      "Está incorreta porque ; pelo contrário, peles naturais mal desinfetadas podem acumular bactérias."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são afirmações incoerentes sem base na tecnologia de enfermagem.",
      "Está incorreta: são afirmações incoerentes sem base na tecnologia de enfermagem.",
      "Está incorreta: são afirmações incoerentes sem base na tecnologia de enfermagem."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: introduzem alterações biológicas absurdas.",
      "Está incorreta: introduzem alterações biológicas absurdas.",
      "Está incorreta: introduzem alterações biológicas absurdas."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: deturpam os objetivos terapêuticos do controlo do microclima.",
      "Está incorreta: deturpam os objetivos terapêuticos do controlo do microclima.",
      "Está incorreta: deturpam os objetivos terapêuticos do controlo do microclima."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria uma espuma extremamente frágil que colapsaria no primeiro minuto.",
      "Está incorreta: violam a física das massas e densidades dos polímeros de poliuretano.",
      "Está incorreta: violam a física das massas e densidades dos polímeros de poliuretano."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: provocariam colapso total da almofada de ar e esmagamento tecidual.",
      "Está incorreta: arruinaria o compressor de ar pneumático.",
      "Está incorreta: arruinaria o compressor de ar pneumático."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: é a definição de força normal compressiva.",
      "Está incorreta: confunde propriedades do heme com a mecânica clássica de deformação tecidual.",
      "Está incorreta: é a definição de força gravítica/peso."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contrariam a hemodinâmica microvascular sob deformação mecânica de corte.",
      "Está incorreta: contrariam a hemodinâmica microvascular sob deformação mecânica de corte.",
      "Está incorreta: contrariam a hemodinâmica microvascular sob deformação mecânica de corte."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: sugere ligações químicas covalentes inexistentes entre queratina e celulose.",
      "Está incorreta: nega a universalidade da gravidade newtoniana sobre toda a matéria com massa.",
      "Está incorreta: não faz sentido hemodinâmico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: descrevem práticas violentas, perigosas ou asfixiantes.",
      "Está incorreta: descrevem práticas violentas, perigosas ou asfixiantes.",
      "Está incorreta: descrevem práticas violentas, perigosas ou asfixiantes."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: provocaria traumatismo articular nos ombros do doente e atrito/cisalhamento extremo na pele.",
      "Está incorreta: são condutas perigosas e desprovidas de qualquer técnica profissional.",
      "Está incorreta: são condutas perigosas e desprovidas de qualquer técnica profissional."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: sugere uma anulação mútua impossível na mecânica tecidual.",
      "Está incorreta: ignoram o efeito destrutivo amplamente documentado na literatura médica.",
      "Está incorreta: ignoram o efeito destrutivo amplamente documentado na literatura médica."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: confundem processos infeciosos superficiais ou dermatites alérgicas com uma necrose isquémica compressiva profunda.",
      "Está incorreta: confundem processos infeciosos superficiais ou dermatites alérgicas com uma necrose isquémica compressiva profunda.",
      "Está incorreta: confundem processos infeciosos superficiais ou dermatites alérgicas com uma necrose isquémica compressiva profunda."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: (85°) causaria cisalhamento devastador com doente a escorregar continuamente.",
      "Está incorreta: (0°) pode dificultar a respiração e favorecer pneumonia por aspiração em doentes com alimentação por sonda.",
      "Está incorreta: é uma situação absurda."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: seria uma manobra vertiginosa perigosa e desumana.",
      "Está incorreta: não possuem qualquer fundamento na biomecânica da transferência.",
      "Está incorreta: não possuem qualquer fundamento na biomecânica da transferência."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: contrariam a mecânica vascular e a dinâmica dos fluidos corporais.",
      "Está incorreta: contrariam a mecânica vascular e a dinâmica dos fluidos corporais.",
      "Está incorreta: contrariam a mecânica vascular e a dinâmica dos fluidos corporais."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: romantizam ou inventam efeitos benéficos inexistentes em dobras de roupa de cama hospitalar.",
      "Está incorreta: romantizam ou inventam efeitos benéficos inexistentes em dobras de roupa de cama hospitalar.",
      "Está incorreta: romantizam ou inventam efeitos benéficos inexistentes em dobras de roupa de cama hospitalar."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: não têm correlação com o mecanismo biomecânico da fricção cutânea repetitiva.",
      "Está incorreta: não têm correlação com o mecanismo biomecânico da fricção cutânea repetitiva.",
      "Está incorreta: não têm correlação com o mecanismo biomecânico da fricção cutânea repetitiva."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: atribuem a lesão a causas microbianas, imunológicas ou magnéticas, ignorando a compressão isquémica direta provocada pelo tubo plástico.",
      "Está incorreta: atribuem a lesão a causas microbianas, imunológicas ou magnéticas, ignorando a compressão isquémica direta provocada pelo tubo plástico.",
      "Está incorreta: atribuem a lesão a causas microbianas, imunológicas ou magnéticas, ignorando a compressão isquémica direta provocada pelo tubo plástico."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: deturpam os efeitos hemodinâmicos preventivos da compressão pneumática sequencial.",
      "Está incorreta: deturpam os efeitos hemodinâmicos preventivos da compressão pneumática sequencial.",
      "Está incorreta: deturpam os efeitos hemodinâmicos preventivos da compressão pneumática sequencial."
    ],
  ...
  },
  {
    ...
    "distractorAnalysis": [
      "Está incorreta: são atitudes antiéticas, negligentes ou inadequadas que contrariam o perfil profissional de um enfermeiro diplomado.",
      "Está incorreta: são atitudes antiéticas, negligentes ou inadequadas que contrariam o perfil profissional de um enfermeiro diplomado.",
      "Está incorreta: são atitudes antiéticas, negligentes ou inadequadas que contrariam o perfil profissional de um enfermeiro diplomado."
    ],
